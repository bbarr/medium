...
export const buffers = _buffers

export function chan(bufferOrN: ?BufferConfig, xduce: ?Object, opts: Object = {}): Channel {
...
export function take(ch: Channel) : Promise<any> {
...
export function put(ch: Channel, v: any) : Promise<any> {
...
export function cancel(ch: Channel, promise: Promise<any>) : void {
...
export function close(ch: Channel) : Channel {
  var currPut;
...
export function go(afn: Function) : Promise<any> { return afn() }
...
export const clone = (src: Channel) : Channel => {
  return chan(...src.args)
}

export function repeat(afn: Function, seed: any) : Promise<any> {
  return go(async () => {
    var result = seed
    while (result !== false) {
...
export function repeatTake(ch: Channel, afn: Function, seed: any) : Promise<any> {
  return go(async () => {
    let result = seed
    while (result !== false) {
...
export function merge(...chs: Array<Channel>) : Channel {
...
export function any(...ports: Array<any>) : Promise<any> {
...
export const CLOSED: Symbol = Symbol('MEDIUM_CLOSED')
